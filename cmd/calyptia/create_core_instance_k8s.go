...
func newCmdCreateCoreInstanceOnK8s(config *config, testClientSet kubernetes.Interface) *cobra.Command {
	...
	var noClusterLoggingPipeline bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			created, err := config.cloud.CreateAggregator(ctx, cloud.CreateAggregator{
				...
				ClusterLogging:         !noClusterLoggingPipeline,
	...
	fs.BoolVar(&noClusterLoggingPipeline, "no-cluster-logging-pipeline", false, "Disable cluster logging pipeline creation.")
