...
require (
	...
	github.com/calyptia/api v1.2.3
	github.com/calyptia/cli/k8s v0.0.0-20230509073739-3fb8a7673248
	github.com/calyptia/core-images-index/go-index v0.0.0-20230505143500-73127e32579e
