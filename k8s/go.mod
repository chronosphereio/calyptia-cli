...
replace github.com/calyptia/cli => ./..
...
require (
	...
	github.com/calyptia/core-images-index/go-index v0.0.0-20230824152146-76a802fcc2ef // indirect
	github.com/calyptia/go-bubble-table v0.2.1 // indirect
	github.com/calyptia/go-fluentbit-config/v2 v2.1.0 // indirect
