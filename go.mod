...
require (
	...
	github.com/calyptia/api v1.2.6
	github.com/calyptia/cli/k8s v0.0.0-20230524102429-9bd3abc01fff
	github.com/calyptia/core-images-index/go-index v0.0.0-20230523071047-5363cc1a3726
