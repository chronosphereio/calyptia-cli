module github.com/chronosphereio/calyptia-cli/k8s

go 1.22

replace (
	github.com/chronosphereio/calyptia-cli => ../.
	github.com/imdario/mergo => github.com/imdario/mergo v0.3.16
)

require (
	github.com/calyptia/api v1.7.1
	github.com/chronosphereio/calyptia-cli v1.15.0
...
require (
	...
	github.com/calyptia/go-fluentbit-config/v2 v2.1.1 // indirect
