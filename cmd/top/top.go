...
func initialProjectModel(ctx context.Context, cloud client.Client, projectID string, metricsStart, metricsInterval time.Duration, last uint) Model {
	return Model{
		currentView: "project",
...
func initialAgentModel(ctx context.Context, cloud client.Client, projectID, agentKey string, metricsStart, metricsInterval time.Duration) Model {
	return Model{
		currentView: "agent",
...
func initialPipelineModel(ctx context.Context, cloud client.Client, projectID, pipelineKey string, metricsStart, metricsInterval time.Duration) Model {
	return Model{
