module github.com/chronosphereio/calyptia-cli

go 1.22

replace (
	github.com/chronosphereio/calyptia-cli/k8s => ./k8s
...
require (
	...
	github.com/calyptia/core-images-index/go-index v0.0.0-20240305172829-582c9074b2bb
	github.com/calyptia/go-fluentbit-config/v2 v2.1.1
	github.com/chronosphereio/calyptia-cli/k8s v0.0.0-20240306170606-6b050973bad4
